...
class UnsupervisedTrainer:
    ...
    def do_train_step(self, dataloader, reg_weight = 0.01, **kwargs) -> Mapping[str, torch.Tensor]:
        """Docstring (TODO)
        """
        ...
        new_record = self.model.train_step(self.optimizer, data_dict, hyper_param_dict, reg_weight = reg_weight)
